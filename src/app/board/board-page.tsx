...
function FilterChip({
  ...
  return (
    <button
      onClick={onClick}
      className={`tracked-label text-[10px] px-2.5 py-1.5 rounded-sm border flex items-center gap-1.5 ${active ? "bg-blueprint text-white border-blueprint" : "bg-surface text-steel border-steel-line"
        }`}
    >
      {color && (
